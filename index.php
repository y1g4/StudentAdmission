<?php
$cn = mysqli_connect("localhost", "root", "peacebewithyouall2020", "admitted");
                ...
                <div class="col-md-4">
                    <div class="logo">
                        <a href="">
                            ...
                            <span>Franklin <span id="na">  University</span></span>
                        </a>
                    </div>
                </div>
    <!--================== Main menu-area ====================-->
    ...
    <footer>
        <div class="container">
            <div class="row">
                    ...
                    <div class="widget">
                        ...
                        <div class="footer-menu">
                            <ul>
                               ...
                               <li><a href="?a=viewf">Faculties</a></li>
                               <li><a href="?a=viewd">Departments</a></li>
                            <li><a href="?a=viewp">Course</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <p class="copy-right">Copyright &copy;Yiga Frank 2021</p>
            </div>
        </div>
    </footer>
