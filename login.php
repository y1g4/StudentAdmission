...
session_start();
error_reporting(0);
include('includes/ind.php');

if(isset($_POST['Admin']))
  {
    $adminuser=$_POST['username'];
    $password=md5($_POST['password']);
    $query=mysqli_query($cn,"SELECT ID from Admin where  username='$adminuser' && password='$password' ");
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h3 style="color: white">Franklin University </h3>
                    <hr  color="red"/>
                </div>
