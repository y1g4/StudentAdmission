<?php
    ...
    else
    {
        ...
        {
            $er++;
            $edivision = "*Please select Course";
        }
        if($er == 0)
        {
            ...
            {
                print '<span class = "successMessage">Data update successfull</span>';
                $row['sname'] = "";
                $row['gname'] = "";
                $row['contact'] = "";
                $row['email'] = "";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="right-side-form">
                                        <h5><label for="class">Campus</label><span class="error">
